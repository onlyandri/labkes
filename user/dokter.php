            ...
            <section class="content-header">
                <h1>
                    ...
                    <div class="pull-right">
                        <a href="dokter_tambah" class="btn bg-purple btn-sm">Tambah Baru</a>
                    </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Tombol Aksi -->
                                                <div class="pull-right">
                                                    <form method="POST" action="_proses/dokter_proses">
                                                        <button type="submit" onclick="return confirm('Anda yakin akan mereset password data ini ?')" class='btn bg-green btn-xs' name="freset" value="y">Reset Password</button>
                                                        <a href='dokter_edit?id=<?php echo $row->user_id; ?>' class='btn bg-orange btn-xs'>Edit</a>
