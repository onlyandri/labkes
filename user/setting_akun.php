...
[Ambil data by id] */
$id_user = $akun;
$sql = $con->query("SELECT * FROM user WHERE id_user = '$id_user' ");
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form id="myform" method="POST" enctype="multipart/form-data" action="_proses/setting_akun">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <input id="username" class="form-control" type="text" maxlength="20" name="username" data-validetta="required" value="<?php echo $row->username; ?>">
                  </div>
                  <!-- /.form-group -->
                </div>
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <input id="password" class="form-control" type="password" maxlength="20" name="password">
                  </div>
                  <!-- /.form-group -->
                </div>
  ...
  <!-- AdminLTE App -->
  <script src="../assets/dist/js/format-uang.js"></script>
  <!-- AdminLTE App -->
  <script src="../assets/dist/js/adminlte.min.js"></script>
  <!-- Sidebar Menu Active -->
  <script>
    $('#nav-pengguna').addClass('active');
