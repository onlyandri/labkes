...
$sql = $con->query("SELECT d.*, u.* FROM dokter d
                            JOIN user u
                ...
                <form id="myform" method="POST" enctype="multipart/form-data" action="_proses/dokter_proses">
                    ...
                    <div class="box box-solid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="namaDokter" class="form-control" type="text" maxlength="100" name="nama_dokter" data-validetta="required" value="<?php echo $row->nama_dokter; ?>">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="Spesifikasi" class="form-control" type="text" maxlength="100" name="spesifikasi" data-validetta="required" value="<?php echo $row->spesifikasi; ?>">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="Tlp" class="form-control" type="text" maxlength="14" name="tlp" onKeyPress="return goodchars(event,'+0123456789',this)" value="<?php echo $row->tlp; ?>">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <input id="Alamat" class="form-control" type="text" name="alamat" value="<?php echo $row->alamat; ?>">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input id="username" class="form-control" type="text" maxlength="20" name="username" data-validetta="required" autocomplete="off" value="<?php echo $row->username; ?>" readonly>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                        ...
                        <div class="box-footer">
                            <input type="hidden" name="id_dokter" value="<?php echo $row->id_dokter; ?>" readonly>
