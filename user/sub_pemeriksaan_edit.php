...
$sql_sub_periksa = $con->query("SELECT * FROM sub_periksa WHERE id_sub_periksa = '$id_sub_periksa' ");
$row_sub_periksa = $sql_sub_periksa->fetch(PDO::FETCH_LAZY);
?>
<!DOCTYPE html>
<html>
        ...
        <form id="myform" method="POST" enctype="multipart/form-data" action="_proses/sub_pemeriksaan_proses">
          ...
          <div class="box box-solid">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="namaSubp" class="form-control" type="text" name="nama_sub_periksa" data-validetta="required" value="<?php echo $row_sub_periksa->nama_sub_periksa; ?>">
                  </div>
                  <!-- /.form-group -->
                </div>
            ...
            <div class="box-footer">
              <input type="hidden" name="id" value="<?php echo $id_sub_periksa; ?>">
