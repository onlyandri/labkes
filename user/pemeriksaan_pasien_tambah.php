    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Tambah Pemeriksaan Pasien
                    <small><?php echo $id_pasien . ' - ' . $row_pasien->nama_pasien; ?></small>
                </h1>
            </section>
                ...
                <form id="myform" method="POST" enctype="multipart/form-data" action="_proses/pemeriksaan_pasien_proses">
                    ...
                    <div class="box box-solid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input id="tglPeriksa" class="form-control" type="text" name="tgl_periksa" data-validetta="required" value="<?php echo date('d/m/Y'); ?>" readonly style="background-color: white;">
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="ketKlinis" class="form-control" type="text" name="ket_klinis">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                ...
                                <div class="row" style="margin-bottom: 20px;">
                                    ...
                                    ?>
                                        <div class="col-lg-3 col-md-3 col-sm-12">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="sub_periksa_id[]" value="<?php echo $row_sub_periksa->id_sub_periksa; ?>"> <?php echo $row_sub_periksa->nama_sub_periksa; ?>
                                                </label>
                                            </div>
                                            <!-- /.checkbox -->
                                        </div>
                        ...
                        <div class="box-footer">
                            <input type="hidden" name="id_pasien" value="<?php echo $id_pasien; ?>" readonly>
